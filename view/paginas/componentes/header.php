...
<body class="sb-nav-fixed">
    <h2 class="d-none" id="dniusuarioparaloscambiosdeestadoXD"><?php echo $dniUsuario; ?></h2>
    <h2 class="d-none" id="estadousuarioparaloscambiosdeestadoXD"><?php echo $estadodeperfil; ?></h2>
